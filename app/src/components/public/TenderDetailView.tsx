...
export function TenderDetailView({ tender, settings }: Props) {
  ...
  return (
    <>
      <PageHero
        ...
        imageFocusX={tender.heroImageFocusX ?? undefined}
        imageFocusY={tender.heroImageFocusY ?? undefined}
        imageZoom={tender.heroImageZoom ?? undefined}
        breadcrumbs={[
          { label: "Home", href: "/" },
